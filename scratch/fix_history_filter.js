...
if (match) {
  ...
  const newBlock = `
          ...
          `
            <!-- Reset Button -->
            <button id="btnResetHistoryFilters" style="padding:6px 12px; border-radius:6px; background:rgba(239,68,68,0.1); color:#ef4444; border:1px solid rgba(239,68,68,0.3); cursor:pointer; font-size:11px; font-weight:bold; display:flex; align-items:center; gap:4px; transition:all 0.2s;">
