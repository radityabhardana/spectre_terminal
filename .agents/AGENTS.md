...
| **Multi-API Fetching, Crash Prevention, Retries** | `error-handling` | `.agents/skills/error-handling/SKILL.md` | Handle multi-source API failures (Binance, DefiLlama, Telegram) with graceful fallbacks and circuit breakers. |
