...
| `src/research.js` | Fetch data eksternal: crypto klines, long/short ratio, DeFiLlama, Fear&Greed, GDELT News, UFC stats |
...
[4] deepAnalyzeMarket() — Pipeline analisis single market
     ...
     │         → UFC? → load dataset UFC offline + GDELT news
     │         → Lainnya (politik, makro)? → GDELT news saja
...
### C. Data UFC (jika market ada kata nama petarung UFC)
| Data | Sumber | Cache |
|---|---|---|
| Statistik fighter (win/loss/reach/dll) | Dataset Kaggle offline (dimuat saat startup via `src/ufc.js`) | N/A |
| Kondisi fisik/mental fighter | DDG HTML scraper (mmafighting.com, sherdog.com, espn.com/mma) | 900 detik |
| Berita terkait | GDELT Doc API 2.1 | 900 detik |

### D. Data Market Non-Crypto Non-UFC (politik, makro, dll.)
| Data | Sumber | Cache |
|---|---|---|
